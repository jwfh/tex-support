...
%	\pagestyle{empty}  %% LaTeX
	...
	\font\big=cmss10 scaled \magstep3 \font\sub=cmss8 at 7pt
	\font\manual=cmr10
	...
	\newdimen\gridheight \gridheight=1.5in % This is the baseline distance grid height
...
%	\def\baselinedist#1{\ifcase#1\or 5\or 6\or 7\or 8\or 9\or 10\or
	\def\baselinedist#1{\ifcase#1\or 8\or 9\or 10\or
		11\or 12\or 13\or 14\or 15\or 16\or 17\or
		18\or 20\or 22\or 24\or 25\or 30\fi}
	...
	\def\centimeterruler{\Stap=1cm \leftrulerfalse
		\multiple=1
		\vollebreedte=0.33in\relax
		\def\rulename{centimeter}%
		\let\ruledigitfont=\rm
		\alltheway=10 \doruler{cm}}
	\def\inchruler{\Stap=72pt \leftrulertrue %% Use 1in if want to typeset using 1in=72.27pt 
		\multiple=1
		\vollebreedte=0.33in\relax
		\def\rulename{inch}%
		\let\ruledigitfont=\rm
		\alltheway=8 \doruler{inch}}
	\def\picaruler{\Stap=12pt \leftrulerfalse  %% Use 12.045pt if want to typeset using 1in=72.27pt 
		\multiple=1
		\vollebreedte=0.33in\relax
		\def\rulename{pica}%
		\let\ruledigitfont=\tiny
		\alltheway=6 \doruler{pica}}
%	\def\pointruler{\Stap=6pt \leftrulerfalse 
%		\multiple=6
%		\vollebreedte=0.33in\relax
%		\def\rulename{point}%
%		\let\ruledigitfont=\tiny
%		\alltheway=3 \doruler{p\kern-0.25pt t\kern-0.675pt .\kern0.375pt{\med(}\kern-1.5pt$\scriptscriptstyle\times 6$\kern-1pt{\med)}}}
	\def\rulerpiece
...
%		\else\box\tempbox\fi}
	...
	%%%%%%%%%%%%%%%%%%%%%%%%% e scale  %%%%%%%%%%%%%%%%%%%%%%%%%%
	\newdimen\eslength \eslength=.75\scalewidth
	\newdimen\intereskip \intereskip=.5\scalewidth
	
	
	\def\fontselect#1#2{
		\def\tcomp{#1}
		\def\serif{serif}
		\def\sserif{sans-serif}
		\ifx\serif\tcomp 
			\def\fname{\ifcase#2\or cmr5\or cmr6\or cmr7\or cmr8
				\or cmr9\or cmr10\or cmr10 at 11pt\or cmr12
				\or cmr12 at 14pt\or cmr12 at 16pt\or cmr17 at 18pt
				\or cmr17 at 20pt\or cmr17 at 24pt\or cmr17 at 26pt
				\or cmr17 at 28pt \or cmr17 at 30pt\or cmr17 at 32pt
				\or cmr17 at 36pt\or  cmr17 at 48pt\or cmr17 at 60pt
				\or cmr17 at 72pt\fi}
			\def\fsize{\ifcase#2\or 5pt\or 6pt\or 7pt\or 8pt
				\or 9pt\or 10pt\or 11pt\or 12pt
				\or 14pt\or 16pt\or 18pt
				\or 20pt\or 24pt\or 26pt
				\or 28pt\or 30pt\or 32pt
				\or 36pt\or 48pt\or 60pt
				\or 72pt\fi}
		\else\ifx\sserif\tcomp
			%sans-serif here
		\fi\fi}
	
	\def\esv         %% #1=E size #2=label
	#1#2{\vtop{\kern0cm
			\hbox{\hbox to 5mm{\tiny \hfil \rulenum{#2}\kern1mm}%
				\vrule height \eslength width #1}
			\kern \intereskip}}
	\let\es=\esv
	\def\rulestackhead    %% #1=minimal label #2=label step
	%% #3=minimal dimen #4=dimen step
...
%			\me3&1.070&&1&.0833&&.376&.0148\cr
%			\me4&12.84&&12&1&&4.513&.1777\cr
%			\me5&1.00375&&&&1&.383&.0139\cr
%			\me6&2.845&.237&2.659&.222&2.835&1&.0394\cr
%			\me7&72.27&6.0225&67.54&5.628&72&25.4&1\cr
			&\strut\hbox to 1cm{\num##}&\strut\hbox to 1cm{\num##}&\strut\hbox to 1cm{\num##}&\strut\hbox to 1cm{\num##}\cr
			\noalign{\hrule}
			\hfill&\tt \me1&\tt \me2&\tt \me6&\tt \me7\cr
			\noalign{\hrule}
			\me1&1&.0833&.351&.0138\cr
			\me2&12&1&4.218&.166\cr
			\me6&2.845&.237&1&.0394\cr
			\me7&72.27&6.0225&25.4&1\cr
			\noalign{\hrule}
	}}
	%%%%%%%%%%%%%%%%%%%%%%%%%% the whole sheet %%%%%%%%%%%%%%%%%%%%%%%%%
...
\def\frontmatter{\begingroup\hsize=12cm \vsize=8in
	...
	\def\smallsheet{\leavevmode
		...
		\box\storea %\kern2mm
		 \picaruler{59}{\storea}
		\box\storea \kern2mm
%		 \pointruler{119}{\storea}
%		\box\storea \kern2mm
		%
		\vtop{
			\baselinegrid{14}\storea \box\storea
			\kern2mm
%			\moveright2mm
			\vbox{\hbox{\ss Baseline Distances (Leading)}
				\neerskip \hrule}
%			\kern2mm %% Vertical kerning!
			%
%			\moveright2mm
			\hbox{
...
%					\magrow{cmr12\\cmbx12\\cmss12\\cmmi12}{250}{36}{1pt}{10}\stored
...
%				\kern1cm
				\vtop{\kern3mm\vbox{\hrule \opskip \hbox{\ss Rule Weights}}
					\kern4mm
					\let\rulenum=\decimalb
					\rulestackhead{5}{5}{0.05mm}{0.05mm}{105}\storeg{mm}
					\rulestack    {110}{10}{.5mm}{0.1mm}{315}\storeh
					\let\rulenum=\decimala
					\rulestackhead{5}{5}{.5pt}{.5pt}{105}\storei{pt}
					\hbox{\box\storeg \kern3mm \box\storeh \kern3mm \box\storei}
					\kern1.75in
				}%end of \vtop
				\kern2mm
				\vtop{\kern3mm\vbox{\hrule \opskip \hbox{\ss E Scale (In Progress)}}
					\kern4mm
					\let\rulenum=\decimalb
					\rulestackhead{5}{5}{0.05mm}{0.05mm}{105}\storeg{mm}
					\rulestack    {110}{10}{.5mm}{0.1mm}{315}\storeh
...
%			}			
			\hbox{
				\vtop{	
					\setbox\storeb=\vtop{\kern0cm 
						...
						\hbox{\hskip1.1cm \big The \TeX\ Ruler}
						\kern2pt
						\hbox{\hskip1cm \sub Adapted for Adobe PostScript Dimensions}
						\kern1pt
						\hbox{\hskip0.75cm \tiny Design:\ {}
							Inge and Victor Eijkhout 1990--96}
						\kern1pt
						\hbox{\hskip1.5cm \tiny Modified:\ {}
							Jacob House 2018}
					}
					\kern4mm
		...
		%
		\kern2mm\relax
		\leftrulerfalse \centimeterruler{24}{\storea}%
		\box\storea%
	}
	
%	\frontmatter
	\smallsheet\kern1.25cm\smallsheet%
%\end{document}
\bye